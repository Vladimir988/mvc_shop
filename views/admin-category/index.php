			...
			<table class="table-bordered table-striped table">
				...
				<?php foreach($categoriesList as $category): ?>
					<tr>
						...
						<td><?php	if($category['status'] == '1') { echo "Отображается";	} else { echo "Скрыт"; } ?></td>
						<td><a href="/admin/category/update/<?php echo $category['id']; ?>" title="Редактировать"><i class="fa fa-pencil-square"></i>Редактировать</a></td>
